...
&kp Q,             &kp W,             &kp E,             &kp R,             &kp T,             &kp Y,             &kp U,             &kp I,             &kp O,             &kp P,             \
U_MT(LALT, A),     U_MT(LSHFT, S),     U_MT(LCTRL, D),    U_MT(LGUI, F),    &kp G,             &kp H,             U_MT(LGUI, J),    U_MT(LCTRL, K),    U_MT(LSHFT, L),     U_MT(LALT, SQT),   \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         &kp DOT,           &kp SLASH,         \
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, SPACE),U_LT(U_MOUSE, TAB),U_LT(U_SYM, RET),  U_LT(U_NUM, BSPC), U_LT(U_FUN, DEL),  U_NP,              U_NP
...
U_NA,              &u_caps_word,      U_NA,              U_NA,              U_NA,              &kp HOME,          U_NA,              &kp UP,            U_NA,              &kp PG_UP,         \
&kp LALT,          &kp LSHFT,         &kp LCTRL,         &kp LGUI,          U_NA,              &kp END,           &kp LEFT,          &kp DOWN,          &kp RIGHT,         &kp PG_DN,         \
U_NA,              U_CUT,             U_CPY,             U_PST,             U_NA,              &kp INS,           U_NA,              U_NA,              U_NA,              U_NA,              \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp RET,           &kp BSPC,          &kp DEL,           U_NP,              U_NP
...
&soft_off,         &u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &studio_unlock,       U_RGB_TOG,         U_RGB_EFF,         U_RGB_HUI,         U_RGB_SAI,         U_RGB_BRI,         \
&kp LALT,          &kp LSHFT,         &kp LCTRL,         &kp LGUI,          U_NA,              U_EP_TOG,          &kp C_PREV,        &kp C_VOL_DN,      &kp C_VOL_UP,      &kp C_NEXT,        \
...
&kp SEMI,          &kp N4,            &kp N5,            &kp N6,            &kp EQUAL,         U_NA,              &kp LGUI,          &kp LCTRL,         &kp LSHFT,         &kp LALT,          \
...
&kp COLON,         &kp DLLR,          &kp PRCNT,         &kp CARET,         &kp PLUS,          U_NA,              &kp LGUI,          &kp LCTRL,         &kp LSHFT,         &kp LALT,          \
...
&kp F12,           &kp F7,            &kp F8,            &kp F9,            &kp PSCRN,         U_NA,              U_NA,              U_NA,              U_NA,              &soft_off,         \
&kp F11,           &kp F4,            &kp F5,            &kp F6,            &kp SLCK,          U_NA,              &kp LGUI,          &kp LCTRL,         &kp LSHFT,         &kp LALT,          \
